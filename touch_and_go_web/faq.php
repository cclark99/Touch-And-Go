...
<body> <!-- start of body tag -->
    ...
    <ul> <!-- start of ul for menu bar -->
        <!-- list home.php link -->
        <li><a class="link" href="index.php">Login</a></li>
        <!-- list schedule.php link -->
        <li><a class="link" href="register.php">Register</a></li>
        <!-- list fakeNav link -->
        <li><a id="fakeNav" class='link' href=""></a></li>
        <!-- list Touch & Go logo -->
    ...
    <section class="dropdown-section"> <!-- start of section tag with dropdown-section class -->
        ...
        <div class="dropdown"> <!-- start of ul tag with dropdown class -->
            ...
            <div class="answer"> <!-- start of div tag with answer class -->
                ...
                <p>We suggest contacting your professor first. If your professor has you marked as present on the
                    specific day,
            ...
            <div class="answer"> <!-- start of div tag with answer class -->
                ...
                <p>Each student's schedule will be posted one week before the start of the semester. If your schedule is
                    not
